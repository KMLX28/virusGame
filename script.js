        ...
        if (gaming_scores == 100)
        {
            ...
            function insert_virus()
            {
                ...
                case 2:
                    ...
                    virus[track2_virus_index] = document.createElement('b')
        
                    virus[track2_virus_index].classList.add(track2_id);
                    
                    if (gaming_scores >= 50 && gaming_scores < 100) {
                        
                        virus[track2_virus_index].style.backgroundColor = '#EAB41B';
                    }
                    
                    if (gaming_scores >= 100 && gaming_scores < 150) {
                        
                        virus[track2_virus_index].style.backgroundColor = '#DB2C2C';
                    }
                    ...
                    track2.append(virus[track2_virus_index]);
...
function track1_viruses_moving(track1_virus_index, num_of_viruses, track1_base, track1_id, virus_speed)
{
    ...
    if (track1_virus_index >= track1_base)
    {
        ...
        var track1_interval = setInterval(frame_of_virus, 1);
    ...
    if (track3_virus_index >= track3_base)
    {
        ...
        function myFunction()
        {
            ...
            virus_element[track3_index_virus].onmouseover = function() {
                ...
                virus_element[track3_index_virus].setAttribute('class', 'd0');
